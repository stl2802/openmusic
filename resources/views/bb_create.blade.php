...
@section ('content')
    <form action="{{ route ('bb.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input name="title" id="txtTitle" class="form-control @error('title') is-invalid @enderror " value="{{old('price')}}">
            @error('title')
        ...
        <div class="mb-3">
            ...
            <textarea name="content" id="txtContent" class="form-control @error('content') is-invalid @enderror " row="3" value="{{old('content')}}">
        ...
        <div>
            <label for="txtMusic" class="form-label">Музыка</label>
        ...
        <div class="mb-3">
            <label for="txtPrice" class="form-label">Leна</label>
